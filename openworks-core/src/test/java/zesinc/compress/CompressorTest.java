...
public class CompressorTest extends TestCase {
    ...
    public void testCompressZip() throws Exception {
        ...
        File compFile = Compressor.compress(CompressType.zip, files, removePath, zipcompressDir, zipFileName);
    ...
    public void testUncompressZip() throws Exception {
        ...
        File uncompressDir = new File(zipuncompressDir);
        List<File> fileList = Compressor.uncompress(CompressType.zip, compFile, uncompressDir);
    ...
    public void testCompressTar() throws Exception {
        ...
        File compFile = Compressor.compress(CompressType.tar, files, removePath, tarcompressDir, tarFileName);
    ...
    public void testUncompressTar() throws Exception {
        ...
        File uncompressDir = new File(taruncompressDir);
        List<File> fileList = Compressor.uncompress(CompressType.tar, compFile, uncompressDir);
