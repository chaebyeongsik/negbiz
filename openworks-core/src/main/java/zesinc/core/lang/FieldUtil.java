...
public class FieldUtil {
     ...
     * <p />
     * <code>java.lang.Class#getDeclaredField</code>를 사용하여 Public 이외의 접근 지시자 <code>Field</code>항목까지
     * 반환한다.
     * <p />
     * 또한 public 지시자를 사용한 것 과 같이 값을 설정할 수 있도록 <code>Field.Accessible</code>이 true 상태가 된다.
     * 
     ...
     * 가져온다.
     * <p />
     * prefix는 get, set, is 등의 이름으로 시작되는 <code>Field</code> 목록만 추출하기 위한 조건으로 사용된다.
     * <p />
     * 또한 public 지시자를 사용한 것 과 같이 값을 설정할 수 있도록 <code>Field.Accessible</code>이 true 상태가 된다.
     * 
     * @param clazz <code>Field</code>를 추출할 대상 <code>Class</code>
