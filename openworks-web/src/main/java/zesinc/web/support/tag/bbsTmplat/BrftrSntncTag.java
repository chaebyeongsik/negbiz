 ...
 * @see
 */
public class BrftrSntncTag extends BbsUiTagSupport {

    /** jsp */
    private static final String DEFAULT_JSP = "bbsTmplat/brftrSntnc.jsp";

    /**
     * 필드명 설정
     */
    public BrftrSntncTag() {
        this.fieldNm = "brftrSntnc";
    }
