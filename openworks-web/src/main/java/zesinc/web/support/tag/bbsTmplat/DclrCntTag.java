 ...
 * @see
 */
public class DclrCntTag extends BbsTagSupport {

    /**
     * 필드명 설정
     */
    public DclrCntTag() {
        this.fieldNm = "dclrCnt";
    }
    ...
    public void doTag() throws JspException, IOException {
        ...
        if("list".equals(this.type)) {
            ...
            html.append("<input type=\"button\" id=\"").append(this.fieldNm).append("\" value=\"신고 ").append(value)
                .append("\" class=\"").append(BbsStyleSupport.BBS_INNER_BUTTON_CLASS).append("\" onclick=\"opUpdateSttemnt(this, '")
